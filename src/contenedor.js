...
class Contenedor {
  ...
  async readFileOrCreateNewOne() {
    try {
      ...
      error.code === "ENOENT"
        ...
        : console.log(
            `Código de error:${error.código}Se produjo un error inesperado al intentar leer${this.filename}`
          );
    }
  }
  ...
  async getById(id) {
    ...
    try {
      ...
      console.log(
        `Código de error:${error.código} Se ha producido un error al intentar obtener un elemento por su ID (${id})`
      );
    }
  }
  ...
  async deleteById(id) {
    try {
      ...
      console.log(
        `Código de error:${error.código} Se ha producido un error al intentar eliminar un elemento por su ID (${id})`
      );
    }
  }
  ...
  async updateById(id, newData) {
    try {
      ...
      `Código de error:${error.código}| Se ha producido un error al intentar actualizar un elemento por su ID (${id}`
    }
  }
  ...
  async save(object) {
    try {
      ...
      console.log(
        `Código de error:${error.código} Se ha producido un error al intentar guardar un elemento`
      );
    }
  }
  ...
  async deleteAll() {
    try {
      ...
      console.log(
        `Se ha producido un error ${error.código} al intentar eliminar todos los objetos`
      );
    }
  }
